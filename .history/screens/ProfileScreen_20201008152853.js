...
const TweetTitleContainer = styled.View`
  flex-direction: row;
      ...
      <UserInfoContainer>
        ...
        <CounterContainer>
          <Counter>
            ...
            <Text style={{ color: "gray", fontSize: 16 }}>Following</Text>
          </Counter>
          <Counter>
            <Text style={{ fontWeight: "bold", marginRight: 5, fontSize: 16 }}>
              123
            </Text>
            <Text style={{ color: "gray", fontSize: 16 }}>Followers</Text>
          </Counter>
        </CounterContainer>
      </UserInfoContainer>
      <TweetTitleContainer>
        <TweetTitle style={{color:"#4d9fec", borderBottomWidth:2}}>Tweets</TweetTitle>
        <TweetTitle style={{color:"gray"}}>Tweets & replies</TweetTitle>
        <TweetTitle style={{color:"gray"}}>Medias</TweetTitle>
        <TweetTitle style={{color:"gray"}}>Likes</TweetTitle>
      </TweetTitleContainer>
    </Container>
  );
};
