  ...
  return (
    <Container>
      ...
      <Bottom>
        <Seperator />
        <BottomTextSection>
          <MaterialCommunityIcons name="earth" size={20} color="#4d9fec" />
          <Text style={{ color: "#4d9fec", marginLeft: 5, fontSize:13 }}>
            Everyone can reply
          </Text>
        </BottomTextSection>
        <Seperator />
        <BottomIconSection>
          ...
          <Feather name="plus-circle" size={24} color="#4d9fec" style={{marginLeft:190}}/>
        </BottomIconSection>
      </Bottom>
    </Container>
  );
