  ...
  return (
    <Container>
      ...
      <Bottom>
        ...
        <Seperator />
        <BottomIconSection>
          <FontAwesome name="image" size={24} color="#4d9fec" />
          <MaterialIcons name="gif" size={24} color="#4d9fec" />
          <MaterialCommunityIcons name="chart-bar" size={24} color="#4d9fec" />
          <SimpleLineIcons name="location-pin" size={24} color="#4d9fec" />
